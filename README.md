...
print_array.c: C function that prints an array of integers.  Provided by ALX School.

print_list.c: C function that prints a listint_t doubly-linked list.  Provided by ALX School.
...
typedef enum kind_e
{
	SPADE = 0,Provided by Holberton School.
	HEART,
	CLUB,
	DIAMOND
} kind_t;
